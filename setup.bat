@echo off
rem hex-launcher : ouvre l'assistant de configuration (app\setup.ps1) dans une fenetre unique, sans console.
...
start "" /min powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "%~dp0app\setup.ps1"
