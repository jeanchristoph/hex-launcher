...
**Description:** « Hextech » est une marque déposée Riot (USPTO 5389278) → renommage en `hex-launcher` (GitHub `gh repo rename`, remote, README, titres d'interface). Mention obligatoire Legal Jibber Jabber en évidence dans les 3 README : « hex-launcher was created under Riot Games' "Legal Jibber Jabber" policy using assets owned by Riot Games. Riot Games does not endorse or sponsor this project. » + non-affiliation.
