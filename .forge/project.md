...
└── app/                         # Tout le moteur — les scripts sont relatifs à $PSScriptRoot
    ...
    ├── lib/riot-client-api.lib.ps1 # API locale du Riot Client : lockfile, transport WinHTTP, langue, lancement et fermeture d'un produit
